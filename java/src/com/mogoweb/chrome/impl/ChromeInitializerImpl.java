...
public class ChromeInitializerImpl {
    ...
    private static WindowAndroid sWindowAndroid = null;
    ...
    public static WindowAndroid getWindowAndroid(Activity activity) {
        if (sWindowAndroid == null)
